...
<body id="page-top">
          ...
          <!--CONTEUDO PRINCIPAL AQUI-->
			...
			<div class="card card-body">
					 ...
					 <!--pegando tabela do banco de dados-->
						<table class="table table-sm " id="tableprof">
						   <thead >
  ...
  <script>
   $(document).ready(function() {
	   let mens_erro = "<div class='alert alert-warning'><i class='glyphicon glyphicon-exclamation-sign'></i><button type=button class='close' data-dismiss='alert'>[X] Fechar</button>Cliente nçao encontrada !</div>"
