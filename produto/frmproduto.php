			 ...
			 <h2 class="text-center">CADASTRO DE PRODUTOS</h2>
			  <hr>
						  ...
						  <div class="form-group">
							...
							<input type="text" class="form-control" id="descricao" placeholder="Informeo produto">
						  </div>
							...
							<div class="form-group col-md-5">
							  ...
							  <input type="text" class="form-control" name="venda" id="venda" value="0">
							</div>
							
							<div class="form-group col-md-5">
							  <label >Estoque</label>
							  <input type="number" class="form-control" id="est" value="0">
							</div>
